          //有直播时需注释没有注释的部分并取消注释有注释的部分，没直播反一下
var player = new Aliplayer({
  ...
  "isLive": false,
  "rePlay": true,
  "cover": "https://zhibo.techzjc.com/cover.jpg",
  "playsinline": true,
  "preload": false,
  "language": "zh-cn",
...
player.on('snapshoted', function (data) {
 ...
 /*        var player = new Aliplayer({
  "id": "player-con",
  "source": "https://livepull.techzjc.com/hgqjdst/yysd.m3u8?auth_key=1572222601-0-0-0bfd6433b5ca602aacb502b825194a7b",
  "width": "100%",
  "height": "500px",
  "autoplay": false,
  "isLive": true,
